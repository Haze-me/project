...
export const postComment = (dishId, rating, author, comment) => (dispatch) => {
    ...
    .then(response => response.json())
    .then(response => dispatch(comment(response)))
...
export const postFeedBack = (name, author, comment) => (dispatch) => {
    ...
    .then(response => response.json())
    .then(response => dispatch(comment(response)))
    .catch(error =>  { console.log('post comments', error.message); alert(' Opps ...Your comment could not be posted\nSORRY: '+error.message); });
};
